...
%
% TODO: is a cycle defined as a set of edges, or should I define a tour as a set of edges forming a
...
discuss the Lin-Kernighan heuristic and the Lin-Kernighan-Helsgaun variant in Section~\ref{sec:lk}
and Section~\ref{sec:lkh}.
