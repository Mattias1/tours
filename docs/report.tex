...
% TODO: With possibly an optimization using LKH - and possibly multiple pertubated runs of savings.
    ...
    % What is this todo below doing here???
    ...
    There are some more additions, for which we refer to Helsgaun's paper~\cite{lkh2}.
    % TODO: possibly write about these additions, that they are not LK improvements, but general
    % improvements.
...
the definition of a tree decomposition in Section!\ref{sec:td-definition}.
    ...
    is guaranteed to have at least two neighbours. % TODO: CHANGED!!!!!!!!!
